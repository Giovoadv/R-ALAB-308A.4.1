...
function createCarouselItem(imgSrc, imgAlt, imgId) {
  ...
  favBtn.id = "button_".concat(imgId);
...
var API_KEY = "live_YsSFSegfe4G7ubhLMGABG40di3GsPR9Mv9a9E517ROPIIS7QgVltFbcE2K9UDRYH";
...
_axios.default.get("https://api.thecatapi.com/v1/breeds").then(function (res) {
  var _iterator = _createForOfIteratorHelper(res.data),
    _step;
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      var breeds = _step.value;
      initialLoad(breeds);
    }
  } catch (err) {
    _iterator.e(err);
...
var initialLoad = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(breeds) {
    var breedsName, breedsId, breedList;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          breedsName = breeds.name;
          breedsId = breeds.id;
          breedList = document.createElement("option");
          breedList.setAttribute("value", "".concat(breedsId));
          breedList.textContent = "".concat(breedsName);
  ...
  return function initialLoad(_x) {
 ...
 */
var handleBreedSelect = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          _axios.default.get("https://api.thecatapi.com/v1/images/search?limit=10&breed_ids=".concat(breedId, "&api_key=").concat(API_KEY), {
            ...
            try {
              for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
                var _breedInfo = _step2.value;
                // console.log(res.data);
                console.log(_breedInfo);
                var catsImg = _breedInfo.url;
                var catsId = _breedInfo.id;
                var carouselItem = Carousel.createCarouselItem(catsImg, "cat", catsId);
            ...
            if (res.data.length <= 0) {
              var breedEmpty = document.createElement("div");
              breedEmpty.innerHTML = "<h1> No Data available at this time </h1>\n        ";
              infoDump.appendChild(breedEmpty);
            } else {
              var _infoDump = document.getElementById("infoDump");
              var breedInfo = document.createElement("div");
              breedInfo.setAttribute("class", "breed-info");
              breedInfo.innerHTML = "\n          <h2>".concat(res.data[0].breeds[0].name, "</h2>\n          <p>Origin: ").concat(res.data[0].breeds[0].origin, "</p>\n          <p>").concat(res.data[0].breeds[0].description, "</p>\n          <p>Life Span: ").concat(res.data[0].breeds[0].life_span, "</p>\n    \n          <h3>Temperament</h3>\n          <p>").concat(res.data[0].breeds[0].temperament, "</p>");
              _infoDump.appendChild(breedInfo);
            }
          }).catch(function (err) {
            console.log(err);
          });
  ...
  return function handleBreedSelect(_x2) {
...
_axios.default.interceptors.request.use(function (config) {
  ...
  var percentCompleted = Math.floor(config.loaded / config.total * 100);
...
var updateProgress = function updateProgress(progressEvent) {
  ...
  var progressBarEl = document.querySelector("#progressBar");
  progressBarEl.style.width = "".concat(Math.floor(progressEvent.loaded / progressEvent.total * 100), "%");
};
...
function _favourite() {
  _favourite = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(imgId) {
    var _favourite2, res, favoriteId, _res;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          _context4.prev = 0;
          _favourite2 = document.querySelector("#button_".concat(imgId));
          if (!_favourite2.classList.contains("favourite-button-active")) {
            _context4.next = 15;
            break;
          }
          _context4.next = 5;
          return _axios.default.get("https://api.thecatapi.com/v1/favourites/?image_id=".concat(imgId), {
            headers: {
              "Content-Type": "application/json",
              "x-api-key": API_KEY
            }
        ...
        case 5:
          ...
          _context4.next = 10;
          return _axios.default.delete("https://api.thecatapi.com/v1/favourites/".concat(favoriteId), {
            headers: {
              "Content-Type": "application/json",
              "x-api-key": API_KEY
            }
        ...
        case 10:
          ...
          _favourite2.classList.remove("favourite-button-active");
          _context4.next = 19;
          break;
        case 15:
          _context4.next = 17;
        ...
        case 17:
          _res = _context4.sent;
          if (_res.status === 200) {
            _favourite2.classList.add("favourite-button-active");
            console.log("Favourited", _res);
          }
        case 19:
          _context4.next = 24;
          break;
...
var getFavourites = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
    var res, _iterator3, _step3, fav, carouselItem;
        ...
        case 3:
          ...
          try {
            for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
              fav = _step3.value;
              carouselItem = Carousel.createCarouselItem(fav.image.url, "cat", fav.image.id);
              Carousel.appendCarousel(carouselItem);
              Carousel.start();
            }
          } catch (err) {
